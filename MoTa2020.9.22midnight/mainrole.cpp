...
{
    switch(this->Level)
        {case 1:if(this->EXP>=9999950){this->atk+=3;  this->defense+=2; this->MAX_HP+=30; this->HP=this->MAX_HP; this->Level=2; this->EXP-=50; this->EXP_To_LevelUP=100;}
                break;
