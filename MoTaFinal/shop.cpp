    ...
    :QWidget(parent)
{
    ...
    arrow->setText("->");
    arrow->setStyleSheet("background-color: rgb(255, 255, 255)");
    arrow->move(250,90);
    ...
    for(int i=0;i<12;i++)
        for(int j=0;j<3;j++)
        {
            ...
            if(i==1||i==2)
                pus[i][0]->setStyleSheet("background-color: rgb(0, 255, 255)");
            if(i==3||i==4||i==5||i==6)
                pus[i][0]->setStyleSheet("background-color: rgb(255, 255, 127)");
            if(i==7||i==8||i==9||i==10||i==11)
                pus[i][0]->setStyleSheet("background-color: rgb(255, 0, 0)");
        }
    hide();
