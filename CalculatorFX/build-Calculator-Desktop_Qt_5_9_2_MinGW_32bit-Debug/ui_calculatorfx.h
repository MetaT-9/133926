...
public:
    ...
    void setupUi(QMainWindow *CalculatorFX)
    {
        ...
        pBtn_Ans->setFont(font);

        gridLayout->addWidget(pBtn_Ans, 2, 4, 1, 2);
        ...
        gridLayout->addWidget(tBtn_function, 2, 0, 1, 4);
        ...
        pBtn_DEL->setFont(font);

        gridLayout->addWidget(pBtn_DEL, 2, 6, 1, 2);
